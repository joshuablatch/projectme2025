...
const ProblemSolution: React.FC = () => {
  return (
    <section id="problem-solution" className="py-24 bg-background section-transition">
      <div className="container mx-auto px-4">
        <div className="max-w-5xl mx-auto">
          <div className="grid md:grid-cols-2 gap-16">
            <div className="space-y-8 opacity-0 animate-fade-up">
              ...
              <div className="space-y-6">
                {challenges.map((challenge, index) => (
                  <div 
                    key={index} 
                    className="bg-background rounded-xl p-6 border border-black/10 card-hover shadow-elevation-1"
            ...
            <div className="space-y-8 opacity-0 animate-fade-up [animation-delay:400ms]">
              <h3 className="text-2xl font-semibold mb-6 text-[#1400a0]">
                The Solution
              </h3>
